...
const CreateAdmin = () => {
  ...
  const [admins, setAdmins] = useState([
    { id: 1, name: "John Super", email: "john@admin.com", role: "super_admin", status: "Active", createdAt: "2024-01-15" },
    { id: 2, name: "Jane Sub", email: "jane@admin.com", role: "sub_admin", status: "Active", createdAt: "2024-02-20" },
    { id: 3, name: "Mike Market", email: "mike@admin.com", role: "market_admin", status: "Inactive", createdAt: "2024-03-10" },
  ]);
