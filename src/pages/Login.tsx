    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/10 via-background to-secondary/10 p-4">
      <Card className="w-full max-w-md shadow-2xl animate-scale-in">
        <CardHeader className="space-y-4 text-center">
          ...
          <CardDescription className="font-sans">Manage your meal planner ecosystem</CardDescription>
        </CardHeader>
        <CardContent>
          <Tabs defaultValue="login" className="w-full">
            <TabsList className="grid w-full grid-cols-2 mb-4">
              <TabsTrigger value="login">Sign In</TabsTrigger>
              <TabsTrigger value="signup" disabled={role !== "super_admin"}>Create Account</TabsTrigger>
            </TabsList>
            ...
            <TabsContent value="login">
              <form onSubmit={handleLogin} className="space-y-4">
                ...
                <Button
                  type="button"
                  variant="link"
                  className="w-full text-muted-foreground font-sans"
